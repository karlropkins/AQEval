...
Get the current release version of __AQEval__ (v`r available.packages(repos = "https://cran.r-project.org/")["AQEval", "Version"]`) from [CRAN](https://cran.r-project.org/) ([archive](https://CRAN.R-project.org/package=AQEval)):
