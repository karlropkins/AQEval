...
Get __AQEval__ from [CRAN](https://cran.r-project.org/):
...
__AQEval__ is on [GitHub](https://github.com) in the [AQEval](https://github.com/karlropkins/AQEval) code archive:
